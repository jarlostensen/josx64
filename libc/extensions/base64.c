...
unsigned char * base64_encode(const unsigned char *src, size_t len,
			      size_t *out_len, generic_allocator_t* allocator)
{
	...
	out = (unsigned char*)allocator->alloc(allocator, olen);
	if (out == NULL)
		return NULL;
			      ...
			      size_t *out_len, generic_allocator_t* allocator)
{
	...
	olen = count / 4 * 3;
	pos = out = allocator->alloc(allocator, olen);
	if (out == NULL)
		return NULL;
