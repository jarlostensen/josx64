...
extern int _JOS_LIBC_FUNC_NAME(snwprintf) (wchar_t* buffer, size_t n, const wchar_t* format, ...);
...
int main(void)
{
	...
	wbuffer[0] = 0;
	int written = _JOS_LIBC_FUNC_NAME(snwprintf)(wbuffer,16,L"Hello wide %s, %3.2f this is 0x%x == %d, and \"%c\"", L"world", 3.1459f, 0xabcdef, 42, L'J');
