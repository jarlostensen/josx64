...
_JOS_INLINE_FUNC _JOS_ALWAYS_INLINE int atomic_compare_exchange_strong(volatile int *object, int expected, int desired) {
    // if expected == *object
    //    *object = desired
    // else
    //     expected = *object
...
_JOS_INLINE_FUNC _JOS_ALWAYS_INLINE int atomic_compare_exchange_weak(volatile int* object, int expected, int desired) {
